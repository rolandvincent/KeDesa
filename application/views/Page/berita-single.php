...
<head>
  ...
  <title>KeDesa - Kelola Desa</title>
  ...
  <link href="<?php base_url('/'); ?>ssets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="<?php base_url('/'); ?>ssets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="<?php base_url('/'); ?>ssets/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="<?php base_url('/'); ?>ssets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li><a href="<?php base_url('/'); ?>Berita">Blog</a></li>
          <li>Blog Single</li>
        </ol>
        <h2>Blog Blog</h2>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="social-links text-center text-md-end pt-3 pt-md-0">
        <a href="#" class="twitter"><i class="bx bxl-twitter"></i>Twitter.com</a>
        <a href="#" class="facebook"><i class="bb bxl-facebook"></i></a>
